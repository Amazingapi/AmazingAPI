...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazingApiRestApiSdk.ApiV1MediasPostRequest1PayloadDataRelationshipsClips();
  });
  ...
  describe('ApiV1MediasPostRequest1PayloadDataRelationshipsClips', function() {
    it('should create an instance of ApiV1MediasPostRequest1PayloadDataRelationshipsClips', function() {
      // uncomment below and update the code to test ApiV1MediasPostRequest1PayloadDataRelationshipsClips
      //var instance = new AmazingApiRestApiSdk.ApiV1MediasPostRequest1PayloadDataRelationshipsClips();
      //expect(instance).to.be.a(AmazingApiRestApiSdk.ApiV1MediasPostRequest1PayloadDataRelationshipsClips);
    });
