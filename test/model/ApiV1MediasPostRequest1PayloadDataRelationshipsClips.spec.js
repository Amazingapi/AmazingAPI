...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestDddSdk.ApiV1MediasPostRequest1PayloadDataRelationshipsClips();
  });
  ...
  describe('ApiV1MediasPostRequest1PayloadDataRelationshipsClips', function() {
    it('should create an instance of ApiV1MediasPostRequest1PayloadDataRelationshipsClips', function() {
      ...
      //var instance = new TestDddSdk.ApiV1MediasPostRequest1PayloadDataRelationshipsClips();
      //expect(instance).to.be.a(TestDddSdk.ApiV1MediasPostRequest1PayloadDataRelationshipsClips);
    });
