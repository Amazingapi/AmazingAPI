...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazingApiRestApiSdk.ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner();
  });
  ...
  describe('ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner', function() {
    it('should create an instance of ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner', function() {
      // uncomment below and update the code to test ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner
      //var instance = new AmazingApiRestApiSdk.ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner();
      //expect(instance).to.be.a(AmazingApiRestApiSdk.ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner);
    });
