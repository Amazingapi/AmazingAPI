...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestDddSdk.ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner();
  });
  ...
  describe('ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner', function() {
    it('should create an instance of ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner', function() {
      ...
      //var instance = new TestDddSdk.ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner();
      //expect(instance).to.be.a(TestDddSdk.ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner);
    });
