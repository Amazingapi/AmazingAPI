...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazingApiRestApiSdk.ApiV1ClipsPostRequest();
  });
  ...
  describe('ApiV1ClipsPostRequest', function() {
    it('should create an instance of ApiV1ClipsPostRequest', function() {
      // uncomment below and update the code to test ApiV1ClipsPostRequest
      //var instance = new AmazingApiRestApiSdk.ApiV1ClipsPostRequest();
      //expect(instance).to.be.a(AmazingApiRestApiSdk.ApiV1ClipsPostRequest);
    });
