...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestDddSdk.ApiV1ClipsPostRequest();
  });
  ...
  describe('ApiV1ClipsPostRequest', function() {
    it('should create an instance of ApiV1ClipsPostRequest', function() {
      ...
      //var instance = new TestDddSdk.ApiV1ClipsPostRequest();
      //expect(instance).to.be.a(TestDddSdk.ApiV1ClipsPostRequest);
    });
