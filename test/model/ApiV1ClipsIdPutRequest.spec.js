...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazingApiRestApiSdk.ApiV1ClipsIdPutRequest();
  });
  ...
  describe('ApiV1ClipsIdPutRequest', function() {
    it('should create an instance of ApiV1ClipsIdPutRequest', function() {
      // uncomment below and update the code to test ApiV1ClipsIdPutRequest
      //var instance = new AmazingApiRestApiSdk.ApiV1ClipsIdPutRequest();
      //expect(instance).to.be.a(AmazingApiRestApiSdk.ApiV1ClipsIdPutRequest);
    });
