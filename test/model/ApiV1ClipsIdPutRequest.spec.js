...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestDddSdk.ApiV1ClipsIdPutRequest();
  });
  ...
  describe('ApiV1ClipsIdPutRequest', function() {
    it('should create an instance of ApiV1ClipsIdPutRequest', function() {
      ...
      //var instance = new TestDddSdk.ApiV1ClipsIdPutRequest();
      //expect(instance).to.be.a(TestDddSdk.ApiV1ClipsIdPutRequest);
    });
