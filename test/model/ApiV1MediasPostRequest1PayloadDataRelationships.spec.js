...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazingApiRestApiSdk.ApiV1MediasPostRequest1PayloadDataRelationships();
  });
  ...
  describe('ApiV1MediasPostRequest1PayloadDataRelationships', function() {
    it('should create an instance of ApiV1MediasPostRequest1PayloadDataRelationships', function() {
      // uncomment below and update the code to test ApiV1MediasPostRequest1PayloadDataRelationships
      //var instance = new AmazingApiRestApiSdk.ApiV1MediasPostRequest1PayloadDataRelationships();
      //expect(instance).to.be.a(AmazingApiRestApiSdk.ApiV1MediasPostRequest1PayloadDataRelationships);
    });
