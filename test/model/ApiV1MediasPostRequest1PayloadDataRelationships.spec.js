...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestDddSdk.ApiV1MediasPostRequest1PayloadDataRelationships();
  });
  ...
  describe('ApiV1MediasPostRequest1PayloadDataRelationships', function() {
    it('should create an instance of ApiV1MediasPostRequest1PayloadDataRelationships', function() {
      ...
      //var instance = new TestDddSdk.ApiV1MediasPostRequest1PayloadDataRelationships();
      //expect(instance).to.be.a(TestDddSdk.ApiV1MediasPostRequest1PayloadDataRelationships);
    });
