...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestDddSdk.ApiV1MediasPostRequestData();
  });
  ...
  describe('ApiV1MediasPostRequestData', function() {
    it('should create an instance of ApiV1MediasPostRequestData', function() {
      ...
      //var instance = new TestDddSdk.ApiV1MediasPostRequestData();
      //expect(instance).to.be.a(TestDddSdk.ApiV1MediasPostRequestData);
    });
