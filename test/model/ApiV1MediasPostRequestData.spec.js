...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazingApiRestApiSdk.ApiV1MediasPostRequestData();
  });
  ...
  describe('ApiV1MediasPostRequestData', function() {
    it('should create an instance of ApiV1MediasPostRequestData', function() {
      // uncomment below and update the code to test ApiV1MediasPostRequestData
      //var instance = new AmazingApiRestApiSdk.ApiV1MediasPostRequestData();
      //expect(instance).to.be.a(AmazingApiRestApiSdk.ApiV1MediasPostRequestData);
    });
