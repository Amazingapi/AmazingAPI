...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazingApiRestApiSdk.ApiV1MediasPostRequest1PayloadDataTranscription();
  });
  ...
  describe('ApiV1MediasPostRequest1PayloadDataTranscription', function() {
    it('should create an instance of ApiV1MediasPostRequest1PayloadDataTranscription', function() {
      // uncomment below and update the code to test ApiV1MediasPostRequest1PayloadDataTranscription
      //var instance = new AmazingApiRestApiSdk.ApiV1MediasPostRequest1PayloadDataTranscription();
      //expect(instance).to.be.a(AmazingApiRestApiSdk.ApiV1MediasPostRequest1PayloadDataTranscription);
    });
