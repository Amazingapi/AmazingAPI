...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestDddSdk.ApiV1MediasPostRequest1PayloadDataTranscription();
  });
  ...
  describe('ApiV1MediasPostRequest1PayloadDataTranscription', function() {
    it('should create an instance of ApiV1MediasPostRequest1PayloadDataTranscription', function() {
      ...
      //var instance = new TestDddSdk.ApiV1MediasPostRequest1PayloadDataTranscription();
      //expect(instance).to.be.a(TestDddSdk.ApiV1MediasPostRequest1PayloadDataTranscription);
    });
