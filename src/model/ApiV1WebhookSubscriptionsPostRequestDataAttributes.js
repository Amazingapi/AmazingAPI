...
class ApiV1WebhookSubscriptionsPostRequestDataAttributes {
    /**
     * Constructs a new <code>ApiV1WebhookSubscriptionsPostRequestDataAttributes</code>.
     * @alias module:model/ApiV1WebhookSubscriptionsPostRequestDataAttributes
     * @param url {String} 
     */
    constructor(url) { 
        
        ApiV1WebhookSubscriptionsPostRequestDataAttributes.initialize(this, url);
    }
    ...
    /**
     * Constructs a <code>ApiV1WebhookSubscriptionsPostRequestDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1WebhookSubscriptionsPostRequestDataAttributes} obj Optional instance to populate.
     * @return {module:model/ApiV1WebhookSubscriptionsPostRequestDataAttributes} The populated <code>ApiV1WebhookSubscriptionsPostRequestDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1WebhookSubscriptionsPostRequestDataAttributes();

            if (data.hasOwnProperty('subscribed_events')) {
                obj['subscribed_events'] = ApiClient.convertToType(data['subscribed_events'], [Object]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1WebhookSubscriptionsPostRequestDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1WebhookSubscriptionsPostRequestDataAttributes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1WebhookSubscriptionsPostRequestDataAttributes.RequiredProperties) {
...
ApiV1WebhookSubscriptionsPostRequestDataAttributes.RequiredProperties = ["url"];

/**
 * @member {Array.<Object>} subscribed_events
 */
ApiV1WebhookSubscriptionsPostRequestDataAttributes.prototype['subscribed_events'] = undefined;

/**
 * @member {String} url
 */
ApiV1WebhookSubscriptionsPostRequestDataAttributes.prototype['url'] = undefined;
...
export default ApiV1WebhookSubscriptionsPostRequestDataAttributes;
