...
import ApiV1MediasPostRequest1PayloadData from './ApiV1MediasPostRequest1PayloadData';
...
class ApiV1MediasPostRequest1Payload {
    /**
     * Constructs a new <code>ApiV1MediasPostRequest1Payload</code>.
     * @alias module:model/ApiV1MediasPostRequest1Payload
     */
    constructor() { 
        
        ApiV1MediasPostRequest1Payload.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasPostRequest1Payload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasPostRequest1Payload} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasPostRequest1Payload} The populated <code>ApiV1MediasPostRequest1Payload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasPostRequest1Payload();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiV1MediasPostRequest1PayloadData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('included')) {
                obj['included'] = ApiClient.convertToType(data['included'], [OneOf]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasPostRequest1Payload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasPostRequest1Payload</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          ApiV1MediasPostRequest1PayloadData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/ApiV1MediasPostRequest1PayloadData} data
 */
ApiV1MediasPostRequest1Payload.prototype['data'] = undefined;

/**
 * @member {Array.<module:model/OneOf>} included
 */
ApiV1MediasPostRequest1Payload.prototype['included'] = undefined;
...
export default ApiV1MediasPostRequest1Payload;
