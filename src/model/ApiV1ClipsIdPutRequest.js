...
import ApiV1ClipsIdPutRequestData from './ApiV1ClipsIdPutRequestData';
...
class ApiV1ClipsIdPutRequest {
    /**
     * Constructs a new <code>ApiV1ClipsIdPutRequest</code>.
     * @alias module:model/ApiV1ClipsIdPutRequest
     * @param data {module:model/ApiV1ClipsIdPutRequestData} 
     */
    constructor(data) { 
        
        ApiV1ClipsIdPutRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>ApiV1ClipsIdPutRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1ClipsIdPutRequest} obj Optional instance to populate.
     * @return {module:model/ApiV1ClipsIdPutRequest} The populated <code>ApiV1ClipsIdPutRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1ClipsIdPutRequest();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiV1ClipsIdPutRequestData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1ClipsIdPutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1ClipsIdPutRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1ClipsIdPutRequest.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          ApiV1ClipsIdPutRequestData.validateJSON(data['data']);
        }
...
ApiV1ClipsIdPutRequest.RequiredProperties = ["data"];

/**
 * @member {module:model/ApiV1ClipsIdPutRequestData} data
 */
ApiV1ClipsIdPutRequest.prototype['data'] = undefined;
...
export default ApiV1ClipsIdPutRequest;
