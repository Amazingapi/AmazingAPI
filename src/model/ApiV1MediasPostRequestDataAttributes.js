...
class ApiV1MediasPostRequestDataAttributes {
    /**
     * Constructs a new <code>ApiV1MediasPostRequestDataAttributes</code>.
     * @alias module:model/ApiV1MediasPostRequestDataAttributes
     */
    constructor() { 
        
        ApiV1MediasPostRequestDataAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasPostRequestDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasPostRequestDataAttributes} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasPostRequestDataAttributes} The populated <code>ApiV1MediasPostRequestDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasPostRequestDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasPostRequestDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasPostRequestDataAttributes</code>.
     */
 ...
 */
ApiV1MediasPostRequestDataAttributes.prototype['description'] = undefined;

/**
 * @member {String} name
 */
ApiV1MediasPostRequestDataAttributes.prototype['name'] = undefined;

/**
 * @member {String} source_url
 */
ApiV1MediasPostRequestDataAttributes.prototype['source_url'] = undefined;

/**
 * @member {String} upload_id
 */
ApiV1MediasPostRequestDataAttributes.prototype['upload_id'] = undefined;
...
export default ApiV1MediasPostRequestDataAttributes;
