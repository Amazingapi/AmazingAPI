...
import ApiV1MediasPostRequestData from './ApiV1MediasPostRequestData';

/**
 * The ApiV1MediasPostRequest model module.
 * @module model/ApiV1MediasPostRequest
 * @version 1.0.1
 */
class ApiV1MediasPostRequest {
    /**
     * Constructs a new <code>ApiV1MediasPostRequest</code>.
     * @alias module:model/ApiV1MediasPostRequest
     * @param data {module:model/ApiV1MediasPostRequestData} 
     */
    constructor(data) { 
        
        ApiV1MediasPostRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasPostRequest} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasPostRequest} The populated <code>ApiV1MediasPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasPostRequest();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiV1MediasPostRequestData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1MediasPostRequest.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          ApiV1MediasPostRequestData.validateJSON(data['data']);
        }
...
ApiV1MediasPostRequest.RequiredProperties = ["data"];

/**
 * @member {module:model/ApiV1MediasPostRequestData} data
 */
ApiV1MediasPostRequest.prototype['data'] = undefined;
...
export default ApiV1MediasPostRequest;
