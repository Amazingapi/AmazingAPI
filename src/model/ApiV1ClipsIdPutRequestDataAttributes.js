...
/**
 * The ApiV1ClipsIdPutRequestDataAttributes model module.
 * @module model/ApiV1ClipsIdPutRequestDataAttributes
 * @version 1.0.1
 */
class ApiV1ClipsIdPutRequestDataAttributes {
    /**
     * Constructs a new <code>ApiV1ClipsIdPutRequestDataAttributes</code>.
     * @alias module:model/ApiV1ClipsIdPutRequestDataAttributes
     */
    constructor() { 
        
        ApiV1ClipsIdPutRequestDataAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1ClipsIdPutRequestDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1ClipsIdPutRequestDataAttributes} obj Optional instance to populate.
     * @return {module:model/ApiV1ClipsIdPutRequestDataAttributes} The populated <code>ApiV1ClipsIdPutRequestDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1ClipsIdPutRequestDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1ClipsIdPutRequestDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1ClipsIdPutRequestDataAttributes</code>.
     */
 ...
 */
ApiV1ClipsIdPutRequestDataAttributes.prototype['end_time'] = undefined;

/**
 * @member {String} name
 */
ApiV1ClipsIdPutRequestDataAttributes.prototype['name'] = undefined;

/**
 * @member {Number} start_time
 */
ApiV1ClipsIdPutRequestDataAttributes.prototype['start_time'] = undefined;
...
export default ApiV1ClipsIdPutRequestDataAttributes;
