...
class ApiV1MediasPostRequest1PayloadDataTranscriptionData {
    /**
     * Constructs a new <code>ApiV1MediasPostRequest1PayloadDataTranscriptionData</code>.
     * @alias module:model/ApiV1MediasPostRequest1PayloadDataTranscriptionData
     */
    constructor() { 
        
        ApiV1MediasPostRequest1PayloadDataTranscriptionData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasPostRequest1PayloadDataTranscriptionData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasPostRequest1PayloadDataTranscriptionData} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasPostRequest1PayloadDataTranscriptionData} The populated <code>ApiV1MediasPostRequest1PayloadDataTranscriptionData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasPostRequest1PayloadDataTranscriptionData();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasPostRequest1PayloadDataTranscriptionData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasPostRequest1PayloadDataTranscriptionData</code>.
     */
 ...
 * @member {String} id
 */
ApiV1MediasPostRequest1PayloadDataTranscriptionData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
ApiV1MediasPostRequest1PayloadDataTranscriptionData.prototype['type'] = undefined;
...
export default ApiV1MediasPostRequest1PayloadDataTranscriptionData;
