...
import ApiV1MediasPostRequest1Payload from './ApiV1MediasPostRequest1Payload';

/**
 * The ApiV1MediasPostRequest1 model module.
 * @module model/ApiV1MediasPostRequest1
 * @version 1.0.0
 */
class ApiV1MediasPostRequest1 {
    /**
     * Constructs a new <code>ApiV1MediasPostRequest1</code>.
     * @alias module:model/ApiV1MediasPostRequest1
     */
    constructor() { 
        
        ApiV1MediasPostRequest1.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasPostRequest1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasPostRequest1} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasPostRequest1} The populated <code>ApiV1MediasPostRequest1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasPostRequest1();

            if (data.hasOwnProperty('event')) {
                obj['event'] = ApiClient.convertToType(data['event'], 'String');
            }
            if (data.hasOwnProperty('payload')) {
                obj['payload'] = ApiV1MediasPostRequest1Payload.constructFromObject(data['payload']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasPostRequest1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasPostRequest1</code>.
     */
    static validateJSON(data) {
        ...
        if (data['payload']) { // data not null
          ApiV1MediasPostRequest1Payload.validateJSON(data['payload']);
        }
 ...
 * @member {String} event
 */
ApiV1MediasPostRequest1.prototype['event'] = undefined;

/**
 * @member {module:model/ApiV1MediasPostRequest1Payload} payload
 */
ApiV1MediasPostRequest1.prototype['payload'] = undefined;
...
export default ApiV1MediasPostRequest1;
