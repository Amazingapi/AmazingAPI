...
import ApiV1MediasIdPutRequestDataAttributes from './ApiV1MediasIdPutRequestDataAttributes';

/**
 * The ApiV1MediasIdPutRequestData model module.
 * @module model/ApiV1MediasIdPutRequestData
 * @version 1.0.1
 */
class ApiV1MediasIdPutRequestData {
    /**
     * Constructs a new <code>ApiV1MediasIdPutRequestData</code>.
     * @alias module:model/ApiV1MediasIdPutRequestData
     * @param attributes {module:model/ApiV1MediasIdPutRequestDataAttributes} 
     */
    constructor(attributes) { 
        
        ApiV1MediasIdPutRequestData.initialize(this, attributes);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasIdPutRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasIdPutRequestData} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasIdPutRequestData} The populated <code>ApiV1MediasIdPutRequestData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasIdPutRequestData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = ApiV1MediasIdPutRequestDataAttributes.constructFromObject(data['attributes']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasIdPutRequestData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasIdPutRequestData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1MediasIdPutRequestData.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          ApiV1MediasIdPutRequestDataAttributes.validateJSON(data['attributes']);
        }
...
ApiV1MediasIdPutRequestData.RequiredProperties = ["attributes"];

/**
 * @member {module:model/ApiV1MediasIdPutRequestDataAttributes} attributes
 */
ApiV1MediasIdPutRequestData.prototype['attributes'] = undefined;
...
export default ApiV1MediasIdPutRequestData;
