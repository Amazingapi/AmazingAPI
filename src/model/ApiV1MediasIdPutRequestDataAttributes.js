...
/**
 * The ApiV1MediasIdPutRequestDataAttributes model module.
 * @module model/ApiV1MediasIdPutRequestDataAttributes
 * @version 1.0.0
 */
class ApiV1MediasIdPutRequestDataAttributes {
    /**
     * Constructs a new <code>ApiV1MediasIdPutRequestDataAttributes</code>.
     * @alias module:model/ApiV1MediasIdPutRequestDataAttributes
     */
    constructor() { 
        
        ApiV1MediasIdPutRequestDataAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasIdPutRequestDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasIdPutRequestDataAttributes} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasIdPutRequestDataAttributes} The populated <code>ApiV1MediasIdPutRequestDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasIdPutRequestDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasIdPutRequestDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasIdPutRequestDataAttributes</code>.
     */
 ...
 */
ApiV1MediasIdPutRequestDataAttributes.prototype['description'] = undefined;

/**
 * @member {String} name
 */
ApiV1MediasIdPutRequestDataAttributes.prototype['name'] = undefined;
...
export default ApiV1MediasIdPutRequestDataAttributes;
