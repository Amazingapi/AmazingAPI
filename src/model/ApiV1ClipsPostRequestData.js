...
import ApiV1ClipsPostRequestDataAttributes from './ApiV1ClipsPostRequestDataAttributes';

/**
 * The ApiV1ClipsPostRequestData model module.
 * @module model/ApiV1ClipsPostRequestData
 * @version 1.0.0
 */
class ApiV1ClipsPostRequestData {
    /**
     * Constructs a new <code>ApiV1ClipsPostRequestData</code>.
     * @alias module:model/ApiV1ClipsPostRequestData
     * @param attributes {module:model/ApiV1ClipsPostRequestDataAttributes} 
     */
    constructor(attributes) { 
        
        ApiV1ClipsPostRequestData.initialize(this, attributes);
    }
    ...
    /**
     * Constructs a <code>ApiV1ClipsPostRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1ClipsPostRequestData} obj Optional instance to populate.
     * @return {module:model/ApiV1ClipsPostRequestData} The populated <code>ApiV1ClipsPostRequestData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1ClipsPostRequestData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = ApiV1ClipsPostRequestDataAttributes.constructFromObject(data['attributes']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1ClipsPostRequestData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1ClipsPostRequestData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1ClipsPostRequestData.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          ApiV1ClipsPostRequestDataAttributes.validateJSON(data['attributes']);
        }
...
ApiV1ClipsPostRequestData.RequiredProperties = ["attributes"];

/**
 * @member {module:model/ApiV1ClipsPostRequestDataAttributes} attributes
 */
ApiV1ClipsPostRequestData.prototype['attributes'] = undefined;
...
export default ApiV1ClipsPostRequestData;
