...
/**
 * The ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner model module.
 * @module model/ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner
 * @version 1.0.0
 */
class ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner {
    /**
     * Constructs a new <code>ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner</code>.
     * @alias module:model/ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner
     */
    constructor() { 
        
        ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner} The populated <code>ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner</code>.
     */
 ...
 * @member {String} id
 */
ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner.prototype['id'] = undefined;

/**
 * @member {String} type
 */
ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner.prototype['type'] = undefined;
...
export default ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner;
