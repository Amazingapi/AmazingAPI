...
import ApiV1WebhookSubscriptionsPostRequestData from './ApiV1WebhookSubscriptionsPostRequestData';

/**
 * The ApiV1WebhookSubscriptionsPostRequest model module.
 * @module model/ApiV1WebhookSubscriptionsPostRequest
 * @version 1.0.1
 */
class ApiV1WebhookSubscriptionsPostRequest {
    /**
     * Constructs a new <code>ApiV1WebhookSubscriptionsPostRequest</code>.
     * @alias module:model/ApiV1WebhookSubscriptionsPostRequest
     * @param data {module:model/ApiV1WebhookSubscriptionsPostRequestData} 
     */
    constructor(data) { 
        
        ApiV1WebhookSubscriptionsPostRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>ApiV1WebhookSubscriptionsPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1WebhookSubscriptionsPostRequest} obj Optional instance to populate.
     * @return {module:model/ApiV1WebhookSubscriptionsPostRequest} The populated <code>ApiV1WebhookSubscriptionsPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1WebhookSubscriptionsPostRequest();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiV1WebhookSubscriptionsPostRequestData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1WebhookSubscriptionsPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1WebhookSubscriptionsPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1WebhookSubscriptionsPostRequest.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          ApiV1WebhookSubscriptionsPostRequestData.validateJSON(data['data']);
        }
...
ApiV1WebhookSubscriptionsPostRequest.RequiredProperties = ["data"];

/**
 * @member {module:model/ApiV1WebhookSubscriptionsPostRequestData} data
 */
ApiV1WebhookSubscriptionsPostRequest.prototype['data'] = undefined;
...
export default ApiV1WebhookSubscriptionsPostRequest;
