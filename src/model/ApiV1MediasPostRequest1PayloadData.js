...
import ApiV1MediasPostRequest1PayloadDataAttributes from './ApiV1MediasPostRequest1PayloadDataAttributes';
import ApiV1MediasPostRequest1PayloadDataRelationships from './ApiV1MediasPostRequest1PayloadDataRelationships';
import ApiV1MediasPostRequest1PayloadDataTranscription from './ApiV1MediasPostRequest1PayloadDataTranscription';

/**
 * The ApiV1MediasPostRequest1PayloadData model module.
 * @module model/ApiV1MediasPostRequest1PayloadData
 * @version 1.0.0
 */
class ApiV1MediasPostRequest1PayloadData {
    /**
     * Constructs a new <code>ApiV1MediasPostRequest1PayloadData</code>.
     * @alias module:model/ApiV1MediasPostRequest1PayloadData
     */
    constructor() { 
        
        ApiV1MediasPostRequest1PayloadData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasPostRequest1PayloadData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasPostRequest1PayloadData} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasPostRequest1PayloadData} The populated <code>ApiV1MediasPostRequest1PayloadData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasPostRequest1PayloadData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = ApiV1MediasPostRequest1PayloadDataAttributes.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = ApiV1MediasPostRequest1PayloadDataRelationships.constructFromObject(data['relationships']);
            }
            if (data.hasOwnProperty('transcription')) {
                obj['transcription'] = ApiV1MediasPostRequest1PayloadDataTranscription.constructFromObject(data['transcription']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasPostRequest1PayloadData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasPostRequest1PayloadData</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          ApiV1MediasPostRequest1PayloadDataAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          ApiV1MediasPostRequest1PayloadDataRelationships.validateJSON(data['relationships']);
        }
        // validate the optional field `transcription`
        if (data['transcription']) { // data not null
          ApiV1MediasPostRequest1PayloadDataTranscription.validateJSON(data['transcription']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/ApiV1MediasPostRequest1PayloadDataAttributes} attributes
 */
ApiV1MediasPostRequest1PayloadData.prototype['attributes'] = undefined;

/**
 * @member {String} id
 */
ApiV1MediasPostRequest1PayloadData.prototype['id'] = undefined;

/**
 * @member {module:model/ApiV1MediasPostRequest1PayloadDataRelationships} relationships
 */
ApiV1MediasPostRequest1PayloadData.prototype['relationships'] = undefined;

/**
 * @member {module:model/ApiV1MediasPostRequest1PayloadDataTranscription} transcription
 */
ApiV1MediasPostRequest1PayloadData.prototype['transcription'] = undefined;

/**
 * @member {String} type
 */
ApiV1MediasPostRequest1PayloadData.prototype['type'] = undefined;
...
export default ApiV1MediasPostRequest1PayloadData;
