...
import ApiV1MediasIdPutRequestData from './ApiV1MediasIdPutRequestData';
...
class ApiV1MediasIdPutRequest {
    /**
     * Constructs a new <code>ApiV1MediasIdPutRequest</code>.
     * @alias module:model/ApiV1MediasIdPutRequest
     * @param data {module:model/ApiV1MediasIdPutRequestData} 
     */
    constructor(data) { 
        
        ApiV1MediasIdPutRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasIdPutRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasIdPutRequest} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasIdPutRequest} The populated <code>ApiV1MediasIdPutRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasIdPutRequest();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiV1MediasIdPutRequestData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasIdPutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasIdPutRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1MediasIdPutRequest.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          ApiV1MediasIdPutRequestData.validateJSON(data['data']);
        }
...
ApiV1MediasIdPutRequest.RequiredProperties = ["data"];

/**
 * @member {module:model/ApiV1MediasIdPutRequestData} data
 */
ApiV1MediasIdPutRequest.prototype['data'] = undefined;
...
export default ApiV1MediasIdPutRequest;
