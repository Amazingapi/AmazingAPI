...
import ApiV1ClipsIdPutRequestDataAttributes from './ApiV1ClipsIdPutRequestDataAttributes';

/**
 * The ApiV1ClipsIdPutRequestData model module.
 * @module model/ApiV1ClipsIdPutRequestData
 * @version 1.0.1
 */
class ApiV1ClipsIdPutRequestData {
    /**
     * Constructs a new <code>ApiV1ClipsIdPutRequestData</code>.
     * @alias module:model/ApiV1ClipsIdPutRequestData
     * @param attributes {module:model/ApiV1ClipsIdPutRequestDataAttributes} 
     */
    constructor(attributes) { 
        
        ApiV1ClipsIdPutRequestData.initialize(this, attributes);
    }
    ...
    /**
     * Constructs a <code>ApiV1ClipsIdPutRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1ClipsIdPutRequestData} obj Optional instance to populate.
     * @return {module:model/ApiV1ClipsIdPutRequestData} The populated <code>ApiV1ClipsIdPutRequestData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1ClipsIdPutRequestData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = ApiV1ClipsIdPutRequestDataAttributes.constructFromObject(data['attributes']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1ClipsIdPutRequestData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1ClipsIdPutRequestData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1ClipsIdPutRequestData.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          ApiV1ClipsIdPutRequestDataAttributes.validateJSON(data['attributes']);
        }
...
ApiV1ClipsIdPutRequestData.RequiredProperties = ["attributes"];

/**
 * @member {module:model/ApiV1ClipsIdPutRequestDataAttributes} attributes
 */
ApiV1ClipsIdPutRequestData.prototype['attributes'] = undefined;
...
export default ApiV1ClipsIdPutRequestData;
