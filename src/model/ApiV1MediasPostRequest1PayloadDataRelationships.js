...
import ApiV1MediasPostRequest1PayloadDataRelationshipsClips from './ApiV1MediasPostRequest1PayloadDataRelationshipsClips';

/**
 * The ApiV1MediasPostRequest1PayloadDataRelationships model module.
 * @module model/ApiV1MediasPostRequest1PayloadDataRelationships
 * @version 1.0.0
 */
class ApiV1MediasPostRequest1PayloadDataRelationships {
    /**
     * Constructs a new <code>ApiV1MediasPostRequest1PayloadDataRelationships</code>.
     * @alias module:model/ApiV1MediasPostRequest1PayloadDataRelationships
     */
    constructor() { 
        
        ApiV1MediasPostRequest1PayloadDataRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasPostRequest1PayloadDataRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasPostRequest1PayloadDataRelationships} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasPostRequest1PayloadDataRelationships} The populated <code>ApiV1MediasPostRequest1PayloadDataRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasPostRequest1PayloadDataRelationships();

            if (data.hasOwnProperty('clips')) {
                obj['clips'] = ApiV1MediasPostRequest1PayloadDataRelationshipsClips.constructFromObject(data['clips']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasPostRequest1PayloadDataRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasPostRequest1PayloadDataRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `clips`
        if (data['clips']) { // data not null
          ApiV1MediasPostRequest1PayloadDataRelationshipsClips.validateJSON(data['clips']);
        }
...
/**
 * @member {module:model/ApiV1MediasPostRequest1PayloadDataRelationshipsClips} clips
 */
ApiV1MediasPostRequest1PayloadDataRelationships.prototype['clips'] = undefined;
...
export default ApiV1MediasPostRequest1PayloadDataRelationships;
