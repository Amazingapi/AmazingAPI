...
import ApiV1MediasPostRequest1PayloadDataTranscriptionData from './ApiV1MediasPostRequest1PayloadDataTranscriptionData';
...
class ApiV1MediasPostRequest1PayloadDataTranscription {
    /**
     * Constructs a new <code>ApiV1MediasPostRequest1PayloadDataTranscription</code>.
     * @alias module:model/ApiV1MediasPostRequest1PayloadDataTranscription
     */
    constructor() { 
        
        ApiV1MediasPostRequest1PayloadDataTranscription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasPostRequest1PayloadDataTranscription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasPostRequest1PayloadDataTranscription} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasPostRequest1PayloadDataTranscription} The populated <code>ApiV1MediasPostRequest1PayloadDataTranscription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasPostRequest1PayloadDataTranscription();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiV1MediasPostRequest1PayloadDataTranscriptionData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasPostRequest1PayloadDataTranscription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasPostRequest1PayloadDataTranscription</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          ApiV1MediasPostRequest1PayloadDataTranscriptionData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/ApiV1MediasPostRequest1PayloadDataTranscriptionData} data
 */
ApiV1MediasPostRequest1PayloadDataTranscription.prototype['data'] = undefined;
...
export default ApiV1MediasPostRequest1PayloadDataTranscription;
