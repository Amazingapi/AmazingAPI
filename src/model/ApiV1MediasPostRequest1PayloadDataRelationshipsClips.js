...
import ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner from './ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner';
...
class ApiV1MediasPostRequest1PayloadDataRelationshipsClips {
    /**
     * Constructs a new <code>ApiV1MediasPostRequest1PayloadDataRelationshipsClips</code>.
     * @alias module:model/ApiV1MediasPostRequest1PayloadDataRelationshipsClips
     */
    constructor() { 
        
        ApiV1MediasPostRequest1PayloadDataRelationshipsClips.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasPostRequest1PayloadDataRelationshipsClips</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasPostRequest1PayloadDataRelationshipsClips} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasPostRequest1PayloadDataRelationshipsClips} The populated <code>ApiV1MediasPostRequest1PayloadDataRelationshipsClips</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasPostRequest1PayloadDataRelationshipsClips();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasPostRequest1PayloadDataRelationshipsClips</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasPostRequest1PayloadDataRelationshipsClips</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/ApiV1MediasPostRequest1PayloadDataRelationshipsClipsDataInner>} data
 */
ApiV1MediasPostRequest1PayloadDataRelationshipsClips.prototype['data'] = undefined;
...
export default ApiV1MediasPostRequest1PayloadDataRelationshipsClips;
