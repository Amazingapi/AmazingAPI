...
import ApiV1ClipsPostRequestData from './ApiV1ClipsPostRequestData';
...
class ApiV1ClipsPostRequest {
    /**
     * Constructs a new <code>ApiV1ClipsPostRequest</code>.
     * @alias module:model/ApiV1ClipsPostRequest
     * @param data {module:model/ApiV1ClipsPostRequestData} 
     */
    constructor(data) { 
        
        ApiV1ClipsPostRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>ApiV1ClipsPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1ClipsPostRequest} obj Optional instance to populate.
     * @return {module:model/ApiV1ClipsPostRequest} The populated <code>ApiV1ClipsPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1ClipsPostRequest();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiV1ClipsPostRequestData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1ClipsPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1ClipsPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1ClipsPostRequest.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          ApiV1ClipsPostRequestData.validateJSON(data['data']);
        }
...
ApiV1ClipsPostRequest.RequiredProperties = ["data"];

/**
 * @member {module:model/ApiV1ClipsPostRequestData} data
 */
ApiV1ClipsPostRequest.prototype['data'] = undefined;
...
export default ApiV1ClipsPostRequest;
