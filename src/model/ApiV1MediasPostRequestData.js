...
import ApiV1MediasPostRequestDataAttributes from './ApiV1MediasPostRequestDataAttributes';
...
class ApiV1MediasPostRequestData {
    /**
     * Constructs a new <code>ApiV1MediasPostRequestData</code>.
     * @alias module:model/ApiV1MediasPostRequestData
     * @param attributes {module:model/ApiV1MediasPostRequestDataAttributes} 
     */
    constructor(attributes) { 
        
        ApiV1MediasPostRequestData.initialize(this, attributes);
    }
    ...
    /**
     * Constructs a <code>ApiV1MediasPostRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MediasPostRequestData} obj Optional instance to populate.
     * @return {module:model/ApiV1MediasPostRequestData} The populated <code>ApiV1MediasPostRequestData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MediasPostRequestData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = ApiV1MediasPostRequestDataAttributes.constructFromObject(data['attributes']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MediasPostRequestData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MediasPostRequestData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1MediasPostRequestData.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          ApiV1MediasPostRequestDataAttributes.validateJSON(data['attributes']);
        }
...
ApiV1MediasPostRequestData.RequiredProperties = ["attributes"];

/**
 * @member {module:model/ApiV1MediasPostRequestDataAttributes} attributes
 */
ApiV1MediasPostRequestData.prototype['attributes'] = undefined;
...
export default ApiV1MediasPostRequestData;
