...
class ApiV1ClipsPostRequestDataAttributes {
    /**
     * Constructs a new <code>ApiV1ClipsPostRequestDataAttributes</code>.
     * @alias module:model/ApiV1ClipsPostRequestDataAttributes
    ...
    constructor(endTime, mediaId, name, startTime) { 
        ...
        ApiV1ClipsPostRequestDataAttributes.initialize(this, endTime, mediaId, name, startTime);
    }
    ...
    /**
     * Constructs a <code>ApiV1ClipsPostRequestDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1ClipsPostRequestDataAttributes} obj Optional instance to populate.
     * @return {module:model/ApiV1ClipsPostRequestDataAttributes} The populated <code>ApiV1ClipsPostRequestDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1ClipsPostRequestDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1ClipsPostRequestDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1ClipsPostRequestDataAttributes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1ClipsPostRequestDataAttributes.RequiredProperties) {
...
ApiV1ClipsPostRequestDataAttributes.RequiredProperties = ["end_time", "media_id", "name", "start_time"];

/**
 * @member {Number} end_time
 */
ApiV1ClipsPostRequestDataAttributes.prototype['end_time'] = undefined;

/**
 * @member {String} media_id
 */
ApiV1ClipsPostRequestDataAttributes.prototype['media_id'] = undefined;

/**
 * @member {String} name
 */
ApiV1ClipsPostRequestDataAttributes.prototype['name'] = undefined;

/**
 * @member {Number} start_time
 */
ApiV1ClipsPostRequestDataAttributes.prototype['start_time'] = undefined;
...
export default ApiV1ClipsPostRequestDataAttributes;
