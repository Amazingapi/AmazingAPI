...
import ApiV1WebhookSubscriptionsPostRequestDataAttributes from './ApiV1WebhookSubscriptionsPostRequestDataAttributes';
...
class ApiV1WebhookSubscriptionsPostRequestData {
    /**
     * Constructs a new <code>ApiV1WebhookSubscriptionsPostRequestData</code>.
     * @alias module:model/ApiV1WebhookSubscriptionsPostRequestData
     * @param attributes {module:model/ApiV1WebhookSubscriptionsPostRequestDataAttributes} 
     */
    constructor(attributes) { 
        
        ApiV1WebhookSubscriptionsPostRequestData.initialize(this, attributes);
    }
    ...
    /**
     * Constructs a <code>ApiV1WebhookSubscriptionsPostRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1WebhookSubscriptionsPostRequestData} obj Optional instance to populate.
     * @return {module:model/ApiV1WebhookSubscriptionsPostRequestData} The populated <code>ApiV1WebhookSubscriptionsPostRequestData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1WebhookSubscriptionsPostRequestData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = ApiV1WebhookSubscriptionsPostRequestDataAttributes.constructFromObject(data['attributes']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1WebhookSubscriptionsPostRequestData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1WebhookSubscriptionsPostRequestData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1WebhookSubscriptionsPostRequestData.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          ApiV1WebhookSubscriptionsPostRequestDataAttributes.validateJSON(data['attributes']);
        }
...
ApiV1WebhookSubscriptionsPostRequestData.RequiredProperties = ["attributes"];

/**
 * @member {module:model/ApiV1WebhookSubscriptionsPostRequestDataAttributes} attributes
 */
ApiV1WebhookSubscriptionsPostRequestData.prototype['attributes'] = undefined;
...
export default ApiV1WebhookSubscriptionsPostRequestData;
